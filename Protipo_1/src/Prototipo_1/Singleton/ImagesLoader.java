...
/*
 * Editor: Juan Carlos Cabrera Vega
 * A01702008
 * Este es un juego en cual adivinas cartas y la pantalla te muestra una letra
 * 
 */
...
{
	private static ImagesLoader instancia=null;
  ...
  loadImagesFile(IMS_FILE);
  
  } 

  public static ImagesLoader getInstancia() {
	  if(instancia==null) {
			instancia = new ImagesLoader();
		}
